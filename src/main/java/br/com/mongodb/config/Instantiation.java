...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post p1 = new Post(null,LocalDate.of(2018, 3, 21),"Partiu viagem","Vou viajar para São Paulo. Abraços", new AuthorDTO(maria));
		Post p2 = new Post(null,LocalDate.of(2018, 3, 23),"Partiu viagem","Vou viajar para São Paulo. Abraços", new AuthorDTO(alex));
